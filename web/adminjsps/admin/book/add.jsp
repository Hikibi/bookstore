...
<%@ page import="com.lanou.bookstore.admin.service.AdminService" %>
...
<style type="text/css">
  ...
  <body>
    ...
    <form action="<c:url value='/AdminServlet?method=addBook'/>" method="post" enctype="multipart/form-data">
		...
		<%
			request.setAttribute("adminCategoryAll", new AdminService().findAll());
		%>
